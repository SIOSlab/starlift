function [combinedcosttime,cost,time,mass,thrustertype,propellant,designvec] = MDOrun_MOO(thrustertype,proppower,propellant, insulation_thk,surface_finish,debris_removed,objective_weighting)
...
designvec = [thrustertype;proppower;propellant;insulation_thk;surface_finish;debris_removed;];
%if time > 10
 %   cost = cost+cost*(time-10);
%end

combinedcosttime = objective_weighting*cost+(1-objective_weighting)*time;
%constraints
% maxTime = 4.2;
% if time >  maxTime
%     cost = cost*1e11;
