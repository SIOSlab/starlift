...
% dWo, 3/15/2002
% function
function [BestProps,bestCost,bestTime,bestMass, bestMassFractions, bestMassFractionsSubsys, bestCostFractions, bestCostFractionsSubsys, bestCostFractionsSC, bestPropFtdrag] = OPTgaFXNBIG()
