...
def animate(num, data_CRTBP, line_CRTBP, data_Moon, line_Moon, data_Earth, line_Earth):
...
ani_CRTBP = animation.FuncAnimation(fig, animate, frames=N_CRTBP//P, fargs=(data_CRTBP, line_CRTBP, data_Moon,
