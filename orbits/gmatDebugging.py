...
# # ~~~~~MOON~~~~~
#
# file_name = "gmatFiles/DebugICRF.txt"
# moon_icrf, _ = gmatTools.extract_pos(file_name)
#
...
# fig, ax = plot_tools.plot_bodies(moon_icrf, moon_rot, moon_i, body_names=body_names, title=title)
