...
#    r_SunEM_r = C_G2B@C_I2R@r_SunEM.to('AU')
#    r_EarthEM_r = C_G2B@C_I2R@r_EarthEM.to('AU')
#    r_MoonEM_r = C_G2B@C_I2R@r_MoonEM.to('AU')
...
#        breakpoint()
    ...
    a_PO_H = G*F_g #- 2*np.cross(e3_hat,v_PEM) - np.cross(e3_hat,np.cross(e3_hat,r_PEM))
    ax = a_PO_H[0]
    ay = a_PO_H[1]
    az = a_PO_H[2]
